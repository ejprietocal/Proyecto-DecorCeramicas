...
const DB={
  bodegas:[
   ...
   productos:[
    {sku:'PC-6060-BE',n:'Piso Cerámico 60×60',      ic:'ri-grid-line',        cat:'Pisos',         precio:28500, costo:18000, descuento_max:15, u:'m²',  caja:1.44, cajaN:'caja',    grad:'linear-gradient(135deg,#D9383A,#7F1D1D)',grupo_conversion_id:'gc-002'},
    {sku:'AZ-3060-BL',n:'Azulejo Baño 30×60',       ic:'ri-layout-grid-line',  cat:'Azulejos',     precio:22300, costo:14000, descuento_max:10, u:'m²',  caja:1.44, cajaN:'caja',    grad:'linear-gradient(135deg,#1D4ED8,#0F2D7A)',grupo_conversion_id:'gc-011'},
    {sku:'RV-2550-GR',n:'Revestimiento Pared',       ic:'ri-stack-line',       cat:'Revestimientos',precio:35800, costo:22000, descuento_max:10, u:'m²',  caja:1.25, cajaN:'caja',    grad:'linear-gradient(135deg,#065F46,#022C22)',grupo_conversion_id:'gc-010'},
    {sku:'GR-LM-CROM',n:'Grifo Lavamanos',           ic:'ri-drop-line',        cat:'Grifería',     precio:45200, costo:30000, descuento_max:20, u:'unid',caja:10,   cajaN:'caja x10',grad:'linear-gradient(135deg,#B45309,#451A03)',grupo_conversion_id:'gc-006'},
    {sku:'GR-CM-CROM',n:'Grifo Cocina Monomando',    ic:'ri-drop-line',        cat:'Grifería',     precio:52000, costo:35000, descuento_max:20, u:'unid',caja:10,   cajaN:'caja x10',grad:'linear-gradient(135deg,#7C3AED,#3B0764)',grupo_conversion_id:'gc-006'},
    {sku:'AD-PORC-25',n:'Adhesivo Porcelana 25kg',   ic:'ri-paint-fill',       cat:'Adhesivos',    precio:38000, costo:25000, descuento_max:10, u:'sacos',caja:40,  cajaN:'pale',    grad:'linear-gradient(135deg,#0369A1,#082F49)',grupo_conversion_id:'gc-004'},
    {sku:'MO-IM-40',  n:'Mortero Impermeable 40kg',  ic:'ri-brick-line',       cat:'Morteros',     precio:35000, costo:22000, descuento_max:10, u:'sacos',caja:50,  cajaN:'pale',    grad:'linear-gradient(135deg,#0E7C66,#064E3B)',grupo_conversion_id:'gc-004'},
    {sku:'MO-PEG-25', n:'Mortero Pegacor 25kg',      ic:'ri-brick-line',       cat:'Morteros',     precio:28000, costo:17000, descuento_max:15, u:'sacos',caja:60,  cajaN:'pale',    grad:'linear-gradient(135deg,#047857,#022C22)',grupo_conversion_id:'gc-004'},
    {sku:'HR-PT-100', n:'Perfil T para enchape 2.4m',ic:'ri-subtract-line',    cat:'Herrería',     precio:8500,  costo:5000,  descuento_max:20, u:'unid',caja:25,  cajaN:'paquete', grad:'linear-gradient(135deg,#4338CA,#1E1B4B)',grupo_conversion_id:'gc-009'},
    {sku:'HR-ES-50',  n:'Escuadra metálica 5×5',     ic:'ri-subtract-line',    cat:'Herrería',     precio:3200,  costo:1800,  descuento_max:25, u:'unid',caja:100, cajaN:'caja',    grad:'linear-gradient(135deg,#6D28D9,#3B0764)',grupo_conversion_id:'gc-009'},
    {sku:'EL-CA-10',  n:'Cable eléctrico #10 100m',  ic:'ri-flashlight-line',  cat:'Eléctricos',   precio:125000,costo:85000, descuento_max:10, u:'unid',caja:10,  cajaN:'caja',    grad:'linear-gradient(135deg,#D97706,#78350F)',grupo_conversion_id:'gc-008'},
    {sku:'EL-TO-20',  n:'Toma corriente doble polar', ic:'ri-flashlight-line',  cat:'Eléctricos',   precio:4500,  costo:2500,  descuento_max:15, u:'unid',caja:50,  cajaN:'caja',    grad:'linear-gradient(135deg,#F59E0B,#92400E)',grupo_conversion_id:'gc-008'},
    {sku:'PT-BL-1',   n:'Pintura Blanca Galaxy 1gal', ic:'ri-palette-line',     cat:'Pinturas',     precio:42000, costo:28000, descuento_max:10, u:'unid',caja:12,  cajaN:'caja',    grad:'linear-gradient(135deg,#0F172A,#334155)',grupo_conversion_id:'gc-003'},
    {sku:'PT-ES-1',   n:'Esmalte Sintético 1/4gal',   ic:'ri-palette-line',     cat:'Pinturas',     precio:18500, costo:11000, descuento_max:15, u:'unid',caja:24,  cajaN:'caja',    grad:'linear-gradient(135deg,#1D4ED8,#0F2D7A)',grupo_conversion_id:'gc-003'},
    {sku:'SN-LV-40',  n:'Lavamanos Vitreo 40cm',      ic:'ri-drop-line',        cat:'Sanitarios',   precio:89000, costo:55000, descuento_max:10, u:'unid',caja:6,   cajaN:'caja',    grad:'linear-gradient(135deg,#0D9488,#115E59)',grupo_conversion_id:'gc-006'},
    {sku:'SN-IN-1',   n:'Inodoro Tanque Bajo',        ic:'ri-drop-line',        cat:'Sanitarios',   precio:210000,costo:140000,descuento_max:10, u:'unid',caja:4,   cajaN:'caja',    grad:'linear-gradient(135deg,#14B8A6,#0F766E)',grupo_conversion_id:'gc-006'},
    {sku:'HR-PA-1',   n:'Palustre dentado 8mm',       ic:'ri-tools-line',       cat:'Herramientas', precio:12500, costo:7000,  descuento_max:20, u:'unid',caja:20,  cajaN:'caja',    grad:'linear-gradient(135deg,#78716C,#292524)',grupo_conversion_id:'gc-007'},
    {sku:'HR-NV-1',   n:'Nivel láser 3 líneas',       ic:'ri-tools-line',       cat:'Herramientas', precio:165000,costo:98000, descuento_max:15, u:'unid',caja:6,   cajaN:'caja',    grad:'linear-gradient(135deg,#A8A29E,#44403C)',grupo_conversion_id:'gc-007'},
    {sku:'PC-4545-BE',n:'Piso Cerámico 45×45 Beige',  ic:'ri-grid-line',        cat:'Pisos',         precio:23500, costo:15000, descuento_max:15, u:'m²',  caja:1.62, cajaN:'caja',    grad:'linear-gradient(135deg,#A16207,#422006)',grupo_conversion_id:'gc-002'},
    {sku:'PC-3333-GR',n:'Piso Cerámico 33×33 Gris',   ic:'ri-grid-line',        cat:'Pisos',         precio:19800, costo:12500, descuento_max:15, u:'m²',  caja:1.08, cajaN:'caja',    grad:'linear-gradient(135deg,#525252,#171717)',grupo_conversion_id:'gc-002'},
    {sku:'AZ-2020-BL',n:'Azulejo Cocina 20×20 Blanco',ic:'ri-layout-grid-line',  cat:'Azulejos',     precio:18500, costo:11500, descuento_max:10, u:'m²',  caja:1.44, cajaN:'caja',    grad:'linear-gradient(135deg,#E2E8F0,#64748B)',grupo_conversion_id:'gc-011'},
    {sku:'AZ-1525-VD',n:'Azulejo Decorativo 15×25',   ic:'ri-layout-grid-line',  cat:'Azulejos',     precio:26500, costo:17000, descuento_max:10, u:'m²',  caja:1.2,  cajaN:'caja',    grad:'linear-gradient(135deg,#059669,#022C22)',grupo_conversion_id:'gc-011'},
    {sku:'RV-2040-BE',n:'Revestimiento Piedra 20×40', ic:'ri-stack-line',       cat:'Revestimientos',precio:32500, costo:20000, descuento_max:10, u:'m²',  caja:1.28, cajaN:'caja',    grad:'linear-gradient(135deg,#78716C,#292524)',grupo_conversion_id:'gc-010'},
    {sku:'RV-1530-ML',n:'Revestimiento Mármol 15×30', ic:'ri-stack-line',       cat:'Revestimientos',precio:38500, costo:24000, descuento_max:10, u:'m²',  caja:1.35, cajaN:'caja',    grad:'linear-gradient(135deg,#A78BFA,#4C1D95)',grupo_conversion_id:'gc-010'},
    {sku:'GR-DU-AL',  n:'Grifo Ducha Aleación',       ic:'ri-drop-line',        cat:'Grifería',     precio:38500, costo:25000, descuento_max:20, u:'unid',caja:10,  cajaN:'caja x10',grad:'linear-gradient(135deg,#0EA5E9,#0C4A6E)',grupo_conversion_id:'gc-006'},
    {sku:'GR-LV-DOR', n:'Grifo Lavamanos Dorado',    ic:'ri-drop-line',         cat:'Grifería',     precio:58000, costo:38000, descuento_max:20, u:'unid',caja:10,  cajaN:'caja x10',grad:'linear-gradient(135deg,#B45309,#78350F)',grupo_conversion_id:'gc-006'},
    {sku:'AD-FLEX-20',n:'Adhesivo Flexiblanco 20kg',  ic:'ri-paint-fill',       cat:'Adhesivos',    precio:34000, costo:22000, descuento_max:10, u:'sacos',caja:50, cajaN:'pale',    grad:'linear-gradient(135deg,#2563EB,#1E3A5F)',grupo_conversion_id:'gc-004'},
    {sku:'AD-CER-GR', n:'Adhesivo Cerámico Gris 25kg',ic:'ri-paint-fill',       cat:'Adhesivos',    precio:32000, costo:20000, descuento_max:10, u:'sacos',caja:40, cajaN:'pale',    grad:'linear-gradient(135deg,#475569,#0F172A)',grupo_conversion_id:'gc-004'},
    {sku:'MO-NIV-25', n:'Mortero Nivelador 25kg',     ic:'ri-brick-line',       cat:'Morteros',     precio:31000, costo:19000, descuento_max:15, u:'sacos',caja:60, cajaN:'pale',    grad:'linear-gradient(135deg,#D97706,#78350F)',grupo_conversion_id:'gc-004'},
    {sku:'MO-REV-30', n:'Mortero Revestimiento 30kg', ic:'ri-brick-line',       cat:'Morteros',     precio:29000, costo:18000, descuento_max:10, u:'sacos',caja:50, cajaN:'pale',    grad:'linear-gradient(135deg,#0891B2,#164E63)',grupo_conversion_id:'gc-004'},
    {sku:'HR-AN-10',  n:'Anclaje metálico 10mm',      ic:'ri-subtract-line',    cat:'Herrería',     precio:2800,  costo:1500,  descuento_max:25, u:'unid',caja:100,cajaN:'caja',    grad:'linear-gradient(135deg,#DC2626,#7F1D1D)',grupo_conversion_id:'gc-009'},
    {sku:'HR-PL-3M',  n:'Pletina acero 3m',           ic:'ri-subtract-line',    cat:'Herrería',     precio:12500, costo:7500,  descuento_max:20, u:'unid',caja:20, cajaN:'paquete', grad:'linear-gradient(135deg,#A3A3A3,#404040)',grupo_conversion_id:'gc-009'},
    {sku:'EL-IN-15',  n:'Interruptor sencillo 15A',   ic:'ri-flashlight-line',  cat:'Eléctricos',   precio:3800,  costo:2200,  descuento_max:15, u:'unid',caja:50, cajaN:'caja',    grad:'linear-gradient(135deg,#FCD34D,#78350F)',grupo_conversion_id:'gc-008'},
    {sku:'EL-CA-12',  n:'Cable trenzado #12 50m',     ic:'ri-flashlight-line',  cat:'Eléctricos',   precio:68000, costo:42000, descuento_max:10, u:'unid',caja:15, cajaN:'caja',    grad:'linear-gradient(135deg,#F97316,#7C2D12)',grupo_conversion_id:'gc-008'},
    {sku:'PT-ES-NEG', n:'Esmalte Negro 1/4gal',       ic:'ri-palette-line',     cat:'Pinturas',     precio:19500, costo:12000, descuento_max:15, u:'unid',caja:24, cajaN:'caja',    grad:'linear-gradient(135deg,#171717,#0A0A0A)',grupo_conversion_id:'gc-003'},
    {sku:'PT-BARN-1', n:'Barniz Marino 1gal',         ic:'ri-palette-line',     cat:'Pinturas',     precio:52000, costo:34000, descuento_max:10, u:'unid',caja:12, cajaN:'caja',    grad:'linear-gradient(135deg,#92400E,#451A03)',grupo_conversion_id:'gc-003'},
    {sku:'SN-LV-60',  n:'Lavamanos Ovalín 60cm',      ic:'ri-drop-line',        cat:'Sanitarios',   precio:125000,costo:78000, descuento_max:10, u:'unid',caja:4,  cajaN:'caja',    grad:'linear-gradient(135deg,#E2E8F0,#334155)',grupo_conversion_id:'gc-006'},
    {sku:'SN-SN-1',   n:'Sanitario Tanque Alto',      ic:'ri-drop-line',        cat:'Sanitarios',   precio:185000,costo:120000,descuento_max:10, u:'unid',caja:3,  cajaN:'caja',    grad:'linear-gradient(135deg,#94A3B8,#1E293B)',grupo_conversion_id:'gc-006'},
    {sku:'HR-CI-30',  n:'Cincel plano 30mm',          ic:'ri-tools-line',       cat:'Herramientas', precio:8500,  costo:5000,  descuento_max:20, u:'unid',caja:30, cajaN:'caja',    grad:'linear-gradient(135deg,#737373,#262626)',grupo_conversion_id:'gc-007'},
    {sku:'HR-MA-5',   n:'Martillo de goma 500g',      ic:'ri-tools-line',       cat:'Herramientas', precio:14500, costo:8500,  descuento_max:20, u:'unid',caja:15, cajaN:'caja',    grad:'linear-gradient(135deg,#DC2626,#450A0A)',grupo_conversion_id:'gc-007'},
    {sku:'PC-POR-60', n:'Piso Porcelanato 60×60',     ic:'ri-grid-line',        cat:'Pisos',         precio:42000, costo:28000, descuento_max:15, u:'m²',  caja:1.44, cajaN:'caja',    grad:'linear-gradient(135deg,#0F172A,#334155)',grupo_conversion_id:'gc-002'},
    {sku:'AZ-2540-VD',n:'Azulejo Verde 25×40',        ic:'ri-layout-grid-line',  cat:'Azulejos',     precio:20500, costo:13000, descuento_max:10, u:'m²',  caja:1.5,  cajaN:'caja',    grad:'linear-gradient(135deg,#166534,#052E16)',grupo_conversion_id:'gc-011'},
    {sku:'RV-3060-BL',n:'Revestimiento Blanco 30×60', ic:'ri-stack-line',       cat:'Revestimientos',precio:34800, costo:21500, descuento_max:10, u:'m²',  caja:1.44, cajaN:'caja',    grad:'linear-gradient(135deg,#F1F5F9,#475569)',grupo_conversion_id:'gc-010'},
    {sku:'GR-FO-DOR', n:'Grifo Fregadero Dorado',     ic:'ri-drop-line',        cat:'Grifería',     precio:62500, costo:40000, descuento_max:20, u:'unid',caja:8,  cajaN:'caja x8', grad:'linear-gradient(135deg,#D97706,#78350F)',grupo_conversion_id:'gc-006'},
    {sku:'AD-MULTI-1',n:'Adhesivo Multiusos 1kg',     ic:'ri-paint-fill',       cat:'Adhesivos',    precio:12500, costo:7500,  descuento_max:15, u:'unid',caja:30, cajaN:'caja',    grad:'linear-gradient(135deg,#DC2626,#7F1D1D)',grupo_conversion_id:'gc-001'},
    {sku:'MO-FR-40',  n:'Mortero Frisbee 40kg',       ic:'ri-brick-line',       cat:'Morteros',     precio:26500, costo:16500, descuento_max:10, u:'sacos',caja:50, cajaN:'pale',    grad:'linear-gradient(135deg,#0EA5E9,#0C4A6E)',grupo_conversion_id:'gc-004'},
    {sku:'HR-VA-1M',  n:'Válvula compuerta 1"',       ic:'ri-subtract-line',    cat:'Herrería',     precio:9500,  costo:5800,  descuento_max:20, u:'unid',caja:40, cajaN:'caja',    grad:'linear-gradient(135deg,#F59E0B,#92400E)',grupo_conversion_id:'gc-009'},
    {sku:'EL-BR-20',  n:'Breaker 20A bipolar',         ic:'ri-flashlight-line',  cat:'Eléctricos',   precio:8500,  costo:5200,  descuento_max:15, u:'unid',caja:30, cajaN:'caja',    grad:'linear-gradient(135deg,#3B82F6,#1E3A5F)',grupo_conversion_id:'gc-008'},
    {sku:'EL-TU-1/2', n:'Tubería PVC 1/2" 3m',        ic:'ri-flashlight-line',  cat:'Eléctricos',   precio:6200,  costo:3800,  descuento_max:15, u:'unid',caja:25, cajaN:'paquete', grad:'linear-gradient(135deg,#78716C,#292524)',grupo_conversion_id:'gc-008'},
    {sku:'SN-DU-ECO', n:'Ducha Eléctrica Eco',         ic:'ri-drop-line',        cat:'Sanitarios',   precio:45000, costo:28000, descuento_max:10, u:'unid',caja:8,  cajaN:'caja',    grad:'linear-gradient(135deg,#0284C7,#0C4A6E)',grupo_conversion_id:'gc-006'}
  ],
  stock:{
  ...
  config:{
    ...
    grupos_conversion:[
      {id:'gc-001',nombre:'Unidades por Pieza',descripcion:'Unidades y cajas, base Unidad',unidad_base_id:'und-1',unidades:[{unidad_id:'und-1',factor:1,codigo:'UND'},{unidad_id:'und-2',factor:10,codigo:'CAJ'}]},
      {id:'gc-002',nombre:'Pisos y Cerámicas m²',descripcion:'Metros cuadrados a cajas de cerámica',unidad_base_id:'und-8',unidades:[{unidad_id:'und-8',factor:1,codigo:'M2'},{unidad_id:'und-2',factor:1.44,codigo:'CAJ'}]},
      {id:'gc-003',nombre:'Pinturas y Líquidos',descripcion:'Galones, litros y mililitros',unidad_base_id:'und-5',unidades:[{unidad_id:'und-5',factor:1,codigo:'L'},{unidad_id:'und-10',factor:3.785,codigo:'GL'},{unidad_id:'und-7',factor:1000,codigo:'ML'}]},
      {id:'gc-004',nombre:'Sacos y Pales',descripcion:'Sacos y agrupación en pales',unidad_base_id:'und-9',unidades:[{unidad_id:'und-9',factor:1,codigo:'SAC'},{unidad_id:'und-1',factor:40,codigo:'UND'}]},
      {id:'gc-005',nombre:'Peso (Kg y g)',descripcion:'Kilogramos y gramos',unidad_base_id:'und-4',unidades:[{unidad_id:'und-4',factor:1,codigo:'KG'},{unidad_id:'und-6',factor:1000,codigo:'G'}]},
      {id:'gc-006',nombre:'Grifería y Sanitarios',descripcion:'Piezas individuales y cajas',unidad_base_id:'und-1',unidades:[{unidad_id:'und-1',factor:1,codigo:'UND'},{unidad_id:'und-2',factor:6,codigo:'CAJ'}]},
      {id:'gc-007',nombre:'Herramientas',descripcion:'Herramientas por pieza',unidad_base_id:'und-1',unidades:[{unidad_id:'und-1',factor:1,codigo:'UND'}]},
      {id:'gc-008',nombre:'Eléctricos',descripcion:'Material eléctrico por pieza',unidad_base_id:'und-1',unidades:[{unidad_id:'und-1',factor:1,codigo:'UND'}]},
      {id:'gc-009',nombre:'Herrería y Perfiles',descripcion:'Perfiles y herrajes por pieza',unidad_base_id:'und-1',unidades:[{unidad_id:'und-1',factor:1,codigo:'UND'}]},
      {id:'gc-010',nombre:'Revestimientos m²',descripcion:'Revestimientos en metros cuadrados',unidad_base_id:'und-8',unidades:[{unidad_id:'und-8',factor:1,codigo:'M2'},{unidad_id:'und-2',factor:1.25,codigo:'CAJ'}]},
      {id:'gc-011',nombre:'Azulejos m²',descripcion:'Azulejos en metros cuadrados',unidad_base_id:'und-8',unidades:[{unidad_id:'und-8',factor:1,codigo:'M2'},{unidad_id:'und-2',factor:1.44,codigo:'CAJ'}]}
    ]
  }
};
